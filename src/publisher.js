 ...
 * @param {number | null} [issueNumber] - When provided, adds a closing reference so GitHub auto-closes the issue on merge
 * @returns {string}
 */
export function renderPrBody(report, hasSecurityFixes, qaFailed = false, issueNumber = null) {
  const lines = [
 ...
 * @param {number | null} [params.issueNumber] - Issue to close when the PR merges
 * @param {boolean} [params.dryRun]
...
export async function openPullRequest({
  ...
  const body = renderPrBody(report, hasSecurityFixes, qaFailed, issueNumber);
